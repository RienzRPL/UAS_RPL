...
<div class="container">
    ...
    <div class="card col-md-6">
        ...
        <div class="box-header with-border">
          <h3 class="box-title text-center">Buat Kode Surat Berita</h3>
        </div>
        <hr>

                <div class="card-body">
                <form action="/adm-surat-berita/simpan" method="post">
                    {{ csrf_field() }}
                ...
                <a href="/adm-surat-berita/detail/{{ $det->id }}" class="btn btn-secondary">Kembali</a>
                </form>

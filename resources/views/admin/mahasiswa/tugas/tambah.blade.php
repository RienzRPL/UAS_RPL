...
<div class="container">
    ...
    <div class="card col-md-6">
        ...
        <div class="box-header with-border">
          <h3 class="box-title text-center">Buat Kode Surat Tugas</h3>
        </div>
        <hr>

                <div class="card-body">
                <form action="/adm-surat-tugas/simpan" method="post">
                    {{ csrf_field() }}
                ...
                <a href="/adm-surat-tugas/detail/{{ $det->id }}" class="btn btn-secondary">Kembali</a>
                </form>

...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="/surat-permohonan"> Surat Permohonan</a></li>
  ...
  <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form"action="/surat-permohonan/simpan" method="post">
            {{ csrf_field() }}
              <div class="box-body">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tabel Permohonan</h3>
            </div>
            <div class="card-body">
<table class="table">
<thead>

...
<div class="container">
    <div class="row">
        ...
        <div class="box-header with-border">
          <h3 class="box-title text-center">Data Pengajuan Surat Permohonan</h3>
        </div>
        <hr>

                <div class="card-body">
                <form action="/surat-permohonan/simpan" method="post">
                    {{ csrf_field() }}
        ...
        <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title text-center">Data Surat Permohonan</h3>
        </div>
        <hr>

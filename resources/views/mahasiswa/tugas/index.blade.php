...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="/surat-tugas"> Surat Tugas</a></li>
        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Tugas</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form"action="/surat-tugas/simpan" method="post">
            {{ csrf_field() }}
              <div class="box-body">
            ...
            <div class="form-group">
                <label for="anggta" class="form-label">Anggota</label>

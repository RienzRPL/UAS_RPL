...
<div class="container">
    <div class="row">
        ...
        <div class="box-header with-border">
          <h3 class="box-title text-center">Data Pengajuan Surat Undangan</h3>
        </div>
        <hr>

                <div class="card-body">
                <form action="/surat-undangan/simpan" method="post">
                    {{ csrf_field() }}
        ...
        <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title text-center">Data Surat Undangan</h3>
        </div>
        <hr>
            ...
            <tbody>
               ...
               <td>
                   <a href="/surat-undangan/edit/{{ $data->id }}" class="btn btn-primary">Edit</a>
                </td>
                </tr>
               @endforeach
            </tbody>
